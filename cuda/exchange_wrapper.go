...
func init() {
	...
	addexchange_args.argptr[17] = unsafe.Pointer(&addexchange_args.arg_JZ)
}

// Wrapper for addexchange CUDA kernel, asynchronous.
func k_addexchange_async(Bx unsafe.Pointer, By unsafe.Pointer, Bz unsafe.Pointer, mx unsafe.Pointer, my unsafe.Pointer, mz unsafe.Pointer, Ms_ unsafe.Pointer, Ms_mul float32, aLUT2d unsafe.Pointer, regions unsafe.Pointer, wx float32, wy float32, wz float32, Nx int, Ny int, Nz int, PBC byte, JZ float32, cfg *config) {
...
)
{
	...
	ld.param.f32 	%f136, [addexchange_param_7];
	ld.param.u64 	%rd13, [addexchange_param_8];
	ld.param.u64 	%rd14, [addexchange_param_9];
	ld.param.f32 	%f34, [addexchange_param_10];
	ld.param.f32 	%f35, [addexchange_param_11];
	ld.param.f32 	%f36, [addexchange_param_12];
	ld.param.u32 	%r31, [addexchange_param_13];
	ld.param.u32 	%r32, [addexchange_param_14];
	ld.param.u32 	%r33, [addexchange_param_15];
	ld.param.f32 	%f37, [addexchange_param_17];
...
$L__BB0_5:
	...
	ld.global.nc.f32 	%f43, [%rd24];
	mul.f32 	%f44, %f43, %f43;
	fma.rn.f32 	%f45, %f42, %f42, %f44;
	fma.rn.f32 	%f46, %f41, %f41, %f45;
	setp.eq.f32 	%p8, %f46, 0f00000000;
	selp.f32 	%f47, %f3, %f41, %p8;
	selp.f32 	%f48, %f2, %f43, %p8;
	selp.f32 	%f49, %f1, %f42, %p8;
	...
	ld.global.nc.f32 	%f50, [%rd28];
	mul.f32 	%f51, %f50, %f34;
	sub.f32 	%f52, %f49, %f1;
	sub.f32 	%f53, %f48, %f2;
	sub.f32 	%f54, %f47, %f3;
	fma.rn.f32 	%f7, %f51, %f52, 0f00000000;
	fma.rn.f32 	%f8, %f51, %f53, 0f00000000;
	fma.rn.f32 	%f9, %f51, %f54, 0f00000000;
	add.s32 	%r11, %r1, 1;
	@%p7 bra 	$L__BB0_7;
	bra.uni 	$L__BB0_6;
...
$L__BB0_8:
	...
	selp.f32 	%f61, %f3, %f55, %p10;
	selp.f32 	%f62, %f2, %f57, %p10;
	selp.f32 	%f63, %f1, %f56, %p10;
	...
	ld.global.nc.f32 	%f64, [%rd36];
	mul.f32 	%f65, %f64, %f34;
	sub.f32 	%f66, %f63, %f1;
	sub.f32 	%f67, %f62, %f2;
	sub.f32 	%f68, %f61, %f3;
	fma.rn.f32 	%f10, %f65, %f66, %f7;
	fma.rn.f32 	%f11, %f65, %f67, %f8;
	fma.rn.f32 	%f12, %f65, %f68, %f9;
	and.b16  	%rs3, %rs5, 2;
...
$L__BB0_11:
	...
	ld.global.nc.f32 	%f71, [%rd40];
	mul.f32 	%f72, %f71, %f71;
	fma.rn.f32 	%f73, %f70, %f70, %f72;
	fma.rn.f32 	%f74, %f69, %f69, %f73;
	setp.eq.f32 	%p12, %f74, 0f00000000;
	selp.f32 	%f75, %f3, %f69, %p12;
	selp.f32 	%f76, %f2, %f71, %p12;
	selp.f32 	%f77, %f1, %f70, %p12;
	...
	sub.f32 	%f81, %f76, %f2;
	sub.f32 	%f82, %f75, %f3;
	fma.rn.f32 	%f13, %f79, %f80, %f10;
	fma.rn.f32 	%f14, %f79, %f81, %f11;
	fma.rn.f32 	%f15, %f79, %f82, %f12;
	add.s32 	%r19, %r2, 1;
	@%p11 bra 	$L__BB0_13;
	bra.uni 	$L__BB0_12;
...
$L__BB0_14:
	...
	ld.global.nc.f32 	%f83, [%rd49];
	ld.global.nc.f32 	%f84, [%rd47];
	ld.global.nc.f32 	%f85, [%rd48];
	mul.f32 	%f86, %f85, %f85;
	fma.rn.f32 	%f87, %f84, %f84, %f86;
	fma.rn.f32 	%f88, %f83, %f83, %f87;
	setp.eq.f32 	%p14, %f88, 0f00000000;
	selp.f32 	%f89, %f3, %f83, %p14;
	selp.f32 	%f90, %f2, %f85, %p14;
	selp.f32 	%f91, %f1, %f84, %p14;
	...
	sub.f32 	%f95, %f90, %f2;
	sub.f32 	%f96, %f89, %f3;
	fma.rn.f32 	%f135, %f93, %f94, %f13;
	fma.rn.f32 	%f134, %f93, %f95, %f14;
	fma.rn.f32 	%f133, %f93, %f96, %f15;
...
$L__BB0_18:
	...
	ld.global.nc.f32 	%f99, [%rd56];
	mul.f32 	%f100, %f99, %f99;
	fma.rn.f32 	%f101, %f98, %f98, %f100;
	fma.rn.f32 	%f102, %f97, %f97, %f101;
	setp.eq.f32 	%p17, %f102, 0f00000000;
	selp.f32 	%f103, %f3, %f97, %p17;
	selp.f32 	%f104, %f2, %f99, %p17;
	selp.f32 	%f105, %f1, %f98, %p17;
	...
	mul.f32 	%f19, %f36, %f37;
	ld.global.nc.f32 	%f106, [%rd60];
	mul.f32 	%f107, %f19, %f106;
	sub.f32 	%f108, %f105, %f1;
	sub.f32 	%f109, %f104, %f2;
	sub.f32 	%f110, %f103, %f3;
	fma.rn.f32 	%f20, %f107, %f108, %f135;
	fma.rn.f32 	%f21, %f107, %f109, %f134;
	fma.rn.f32 	%f22, %f107, %f110, %f133;
	add.s32 	%r27, %r3, 1;
	@%p16 bra 	$L__BB0_20;
	bra.uni 	$L__BB0_19;
...
$L__BB0_21:
	...
	ld.global.nc.f32 	%f111, [%rd65];
	ld.global.nc.f32 	%f112, [%rd63];
	ld.global.nc.f32 	%f113, [%rd64];
	mul.f32 	%f114, %f113, %f113;
	fma.rn.f32 	%f115, %f112, %f112, %f114;
	fma.rn.f32 	%f116, %f111, %f111, %f115;
	setp.eq.f32 	%p19, %f116, 0f00000000;
	selp.f32 	%f117, %f3, %f111, %p19;
	selp.f32 	%f118, %f2, %f113, %p19;
	selp.f32 	%f119, %f1, %f112, %p19;
	...
	mul.f32 	%f121, %f19, %f120;
	sub.f32 	%f122, %f119, %f1;
	sub.f32 	%f123, %f118, %f2;
	sub.f32 	%f124, %f117, %f3;
	fma.rn.f32 	%f135, %f121, %f122, %f20;
	fma.rn.f32 	%f134, %f121, %f123, %f21;
	fma.rn.f32 	%f133, %f121, %f124, %f22;
...
$L__BB0_22:
	...
	ld.global.nc.f32 	%f125, [%rd71];
	mul.f32 	%f136, %f125, %f136;

$L__BB0_24:
	setp.eq.f32 	%p21, %f136, 0f00000000;
...
$L__BB0_26:
	...
	ld.global.f32 	%f127, [%rd74];
	fma.rn.f32 	%f128, %f135, %f137, %f127;
	st.global.f32 	[%rd74], %f128;
	cvta.to.global.u64 	%rd75, %rd7;
	add.s64 	%rd76, %rd75, %rd15;
	ld.global.f32 	%f129, [%rd76];
	fma.rn.f32 	%f130, %f134, %f137, %f129;
	st.global.f32 	[%rd76], %f130;
	cvta.to.global.u64 	%rd77, %rd8;
	add.s64 	%rd78, %rd77, %rd15;
	ld.global.f32 	%f131, [%rd78];
	fma.rn.f32 	%f132, %f133, %f137, %f131;
	st.global.f32 	[%rd78], %f132;
