...
all: cudakernels hooks
	go install -v $(GO_BUILDFLAGS) github.com/kuchkin/mumax3-gneb/...
...
test: all
	go test -vet=off -i github.com/kuchkin/mumax3-gneb/...
	go test -vet=off $(PKGS)  github.com/kuchkin/mumax3-gneb/...
	cd test && ./run.bash
...
clean:
	rm -frv $(GOPATH)/pkg/*/github.com/kuchkin/mumax3-gneb/*
