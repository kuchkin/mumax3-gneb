...
<body>
<iframe src="http://kuchkin.github.io/header.html" width="100%" height="180" frameborder="0"></iframe>
...
{{.Data.Div "solver"}}
	...
	Type: {{.Select "solvertype" "rk45" "bw_euler" "euler" "heun" "rk4" "rk23" "rk45" "rkf56" "rk4D"}}
	<table>
		<tr> <td>
